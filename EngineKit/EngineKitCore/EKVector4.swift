...
public class EKVector4: EKVector4Type {
	public let x: Double
	public let y: Double
	public let z: Double
	public let w: Double
	...
	public static func createVector(x x: Double,
	                                  y: Double,
	                                  z: Double,
	                                  w: Double) -> EKVector4Type {
		return EKVector4(x: x, y: y, z: z, w: w)
	}
}

//
public protocol EKVector4Type: class, CustomDebugStringConvertible {
...
extension EKVector4Type {
	public func plus(object: Any) -> EKVector4Type {
	...
	public func minus(object: Any) -> EKVector4Type {
		let vector = Self.createVector(object: object)
		return Self.createVector(x: self.x - vector.x,
		                         y: self.y - vector.y,
		                         z: self.z - vector.z,
	...
	public func times(scalar: Double) -> EKVector4Type {
	...
	public func over(scalar: Double) -> EKVector4Type {
		return self.times(1/scalar)
	}

	public func opposite() -> EKVector4Type {
	...
	public func normalize() -> EKVector4Type {
		return self.over(self.norm())
	}

	public func translate(object: Any) -> EKVector4Type {
		return self.plus(object)
	}

	public func scale(object: Any) -> EKVector4Type {
		let vector = Self.createVector(object: object)
		return Self.createVector(x: self.x * vector.x,
		                         y: self.y * vector.y,
		                         z: self.z * vector.z,
...
extension EKVector4Type {
	...
	public static func origin() -> EKVector4Type {
		return Self.createVector(x: 0, y: 0, z: 0, w: 1)
	}

	public static func createVector(xyz xyz: Double) -> EKVector4Type {
	...
	public static func createVector(array array: [Double]) -> EKVector4Type {
	...
	public static func createVector(dictionary
		dictionary: [String: Double]) -> EKVector4Type {
	...
	public static func createVector(string string: String) -> EKVector4Type {
		var strings = [string]
	...
	public static func createVector(object object: Any) -> EKVector4Type {
		if let vector = object as? EKVector4Type {
			return vector
