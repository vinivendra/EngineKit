...
extension EKVector3 {
	...
	public static func createVector(fromDictionary dictionary: [String: Double])
		-> EKVector3 {
			...
			return EKVector3(x: dictionary[zero: ["0", "x", "X"]],
	...
	public static func createVector(fromObject object: Any) -> EKVector3 {
